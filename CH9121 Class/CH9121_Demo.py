...
eth = CH9121()                      # Initialize the CH9121 device for Uart0 only (default)
#eth = CH9121(1)                     # Initialize the CH9121 device for Uart0 only
#eth = CH9121(2)                     # Initialize the CH9121 device for both Uart0 & Uart1
...
eth.gateway = (192,168,1,1)         # gateway / Router of LAN
...
eth.cabledisconnect = NO            # set to disconnect network cable by software command, NO/YES (Optional)
eth.devicename = b'PicoEth'         # devicename of CH9121 as seen on the network, replace "PicoEth". (Optional) (maximum length 28 bytes)
...
eth.ethfile = "CH9121settings.txt"  # readsettings() will also write the data to ethfile when readtofile = True
