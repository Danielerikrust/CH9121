...
Interestingly, setting UART0 or UART1 to "Mode 3-UDP Server" will automatically set the Target_IP for that UART to 255.255.255.255. A workaround is to set the Local_IP to *.255, such as 192.168.0.255.
